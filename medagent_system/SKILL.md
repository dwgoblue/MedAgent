...
description: Use this skill when implementing or extending the actual MedGemma x SynthLab x BioMCP runtime in medagent_system, including agent contracts, CPB/CCG/claim schemas, evidence verification, and causal perturbation robustness.
---
...
- Building the runtime agent graph in `medagent_system/runtime`.
- Implementing evidence contracts and BioMCP verification loops.
- Adding causal verification and sensitivity mapping.
- Extending factory workflows, tests, or CI in `medagent_system/factory`.
