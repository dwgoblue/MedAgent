...
- `MEDAGENT_RAG_ROOTS` (default `medagent_system/docs:synthlab/docs`)
...
python3 medagent_system/runtime/run_mvp.py \
  ...
  --output medagent_system/runtime/examples/run_output.json
```
...
```bash
pytest -q medagent_system/factory/tests/test_v2_smoke.py \
         medagent_system/factory/tests/test_biomcp_policy_v2.py
```
...
```bash
export MEDAGENT_RUN_LOG_DIR=medagent_system/runtime/examples/logs/run1
export MEDAGENT_PIPELINE_MODE=v2
python3 medagent_system/runtime/run_mvp.py
```
