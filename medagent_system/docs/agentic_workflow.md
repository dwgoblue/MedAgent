...
- File: `medagent_system/runtime/harness/synthlab_runner.py`
...
- File: `medagent_system/runtime/agents/orchestrator/engine.py`
...
- File: `medagent_system/runtime/agents/biomcp_verifier/agent.py`

6. RAG
- Local retrieval over documentation corpus (`medagent_system/docs`, `synthlab/docs` by default).
- File: `medagent_system/runtime/tools/retrieval/simple_rag.py`

7. Reasoning
- Optional OpenAI model (`gpt-5.2` default) classifies claim support as pass/weak/fail.
- File: `medagent_system/runtime/tools/openai_client/client.py`
...
- File: `medagent_system/runtime/tools/exec_env/biomni_adapter.py`

9. Causal robustness
- Counterfactual sensitivity checks produce sensitivity map.
- File: `medagent_system/runtime/agents/causal_verifier/agent.py`
...
- File: `medagent_system/runtime/agents/synthesis/agent.py`
