...
from medagent_system.runtime.harness.biomcp_gate import grade_prediction_with_biomcp
from medagent_system.runtime.harness.eval_labels import extract_primary_encounter_dx, normalize_label
from medagent_system.runtime.harness.synthlab_runner import _import_synthlab, _patient_to_cpb
    ...
    *,
    ...
    for patient in dataset:
        ...
        row = {
            ...
            "problems_predicted": final.problem_list_ranked,
        }
        rows.append(row)
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=str, default="medagent_system/runtime/examples/benchmark_runs/latest")
