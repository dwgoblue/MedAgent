...
Use the local `Biomni` clone as the execution substrate and tool-orchestration backbone, while keeping MedAgent-specific schemas, stop conditions, and safety policy in `medagent`.
